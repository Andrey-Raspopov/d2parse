...
def PutPortraitAbility(parent_image, ability_image, ability_pos, abilities_info):
    if ability_pos == 1:
        parent_image[1500:1500+100,800:800+100,:] = ability_image
        cv2.putText(parent_image, str(abilities_info['ability_level']), (840, 1630), cv2.FONT_HERSHEY_SIMPLEX, 
                    1, colors['white'], 2, cv2.LINE_4)
        cv2.putText(parent_image, str(int(abilities_info['ability_cool'])), (870, 1600), cv2.FONT_HERSHEY_SIMPLEX, 
                    1, colors['magenta'], 2, cv2.LINE_4)
    elif ability_pos == 2:
        parent_image[1500:1500+100,910:910+100,:] = ability_image
        cv2.putText(parent_image, str(abilities_info['ability_level']), (950, 1630), cv2.FONT_HERSHEY_SIMPLEX, 
                    1, colors['white'], 2, cv2.LINE_4)
        cv2.putText(parent_image, str(int(abilities_info['ability_cool'])), (980, 1600), cv2.FONT_HERSHEY_SIMPLEX, 
                    1, colors['magenta'], 2, cv2.LINE_4)
    elif ability_pos == 3:
        parent_image[1500:1500+100,1020:1020+100,:] = ability_image
        cv2.putText(parent_image, str(abilities_info['ability_level']), (1060, 1630), cv2.FONT_HERSHEY_SIMPLEX, 
                    1, colors['white'], 2, cv2.LINE_4)
        cv2.putText(parent_image, str(int(abilities_info['ability_cool'])), (1090, 1600), cv2.FONT_HERSHEY_SIMPLEX, 
                    1, colors['magenta'], 2, cv2.LINE_4)
    elif ability_pos == 4:
        parent_image[1500:1500+100,1130:1130+100,:] = ability_image
        cv2.putText(parent_image, str(abilities_info['ability_level']), (1170, 1630), cv2.FONT_HERSHEY_SIMPLEX, 
                    1, colors['white'], 2, cv2.LINE_4)
        cv2.putText(parent_image, str(int(abilities_info['ability_cool'])), (1200, 1600), cv2.FONT_HERSHEY_SIMPLEX, 
                    1, colors['magenta'], 2, cv2.LINE_4)
    elif ability_pos == 5:
        parent_image[1500:1500+100,1240:1240+100,:] = ability_image
        cv2.putText(parent_image, str(abilities_info['ability_level']), (1290, 1630), cv2.FONT_HERSHEY_SIMPLEX, 
                    1, colors['white'], 2, cv2.LINE_4)
        cv2.putText(parent_image, str(int(abilities_info['ability_cool'])), (1310, 1600), cv2.FONT_HERSHEY_SIMPLEX, 
                    1, colors['magenta'], 2, cv2.LINE_4)
    elif ability_pos == 6:
        parent_image[1500:1500+100,1350:1350+100,:] = ability_image
        cv2.putText(parent_image, str(abilities_info['ability_level']), (1390, 1630), cv2.FONT_HERSHEY_SIMPLEX, 
                    1, colors['white'], 2, cv2.LINE_4)
        cv2.putText(parent_image, str(int(abilities_info['ability_cool'])), (1420, 1600), cv2.FONT_HERSHEY_SIMPLEX, 
                    1, colors['magenta'], 2, cv2.LINE_4)
...
water_rune_icon = cv2.imread("/home/araspopov/Downloads/MWII-003-PREORDER-NEW-001.jpg", cv2.IMREAD_UNCHANGED)
...
class HeroRendering(object):
    ...
    def rendering_map(self, parent_image, hero_name, hero_info_dict, move_to_position_x, move_to_position_y, no_target_ability, 
        ...
        self.abilities_info = hero_info_dict['abilities_info']
    ...
    def rendering_portrait(self, parent_image, heros_modifiers):
        if self.abilities_info != None:
          if self.ability_image1_flag == False:
            if self.abilities_info['ability0']['ability_name'] != 'generic_hidden':
              self.ability_image1 = GetAbilityImage(self.abilities_info['ability0']['ability_name'])
              self.ability_image1_flag = True
          if self.ability_image2_flag == False:
            if self.abilities_info['ability1']['ability_name'] != 'generic_hidden':
              self.ability_image2 = GetAbilityImage(self.abilities_info['ability1']['ability_name'])
              self.ability_image2_flag = True
          if self.ability_image3_flag == False:
            if self.abilities_info['ability2']['ability_name'] != 'generic_hidden':
              self.ability_image3 = GetAbilityImage(self.abilities_info['ability2']['ability_name'])
              self.ability_image3_flag = True
          if self.ability_image4_flag == False:
            if self.abilities_info['ability3']['ability_name'] != 'generic_hidden':
              self.ability_image4 = GetAbilityImage(self.abilities_info['ability3']['ability_name'])
              self.ability_image4_flag = True
          if self.ability_image5_flag == False:
            if self.abilities_info['ability4']['ability_name'] != 'generic_hidden':
              self.ability_image5 = GetAbilityImage(self.abilities_info['ability4']['ability_name'])
              self.ability_image5_flag = True
          if self.ability_image6_flag == False:
            if self.abilities_info['ability5']['ability_name'] != 'generic_hidden':
              self.ability_image6 = GetAbilityImage(self.abilities_info['ability5']['ability_name'])
        ...
        if self.ability_image1_flag:
          PutPortraitAbility(parent_image, self.ability_image1, 1, self.abilities_info['ability0'])

        if self.ability_image2_flag:
          PutPortraitAbility(parent_image, self.ability_image2, 2, self.abilities_info['ability1'])

        if self.ability_image3_flag:
          PutPortraitAbility(parent_image, self.ability_image3, 3, self.abilities_info['ability2'])

        if self.ability_image4_flag:
          PutPortraitAbility(parent_image, self.ability_image4, 4, self.abilities_info['ability3'])

        if self.ability_image5_flag:
          PutPortraitAbility(parent_image, self.ability_image5, 5, self.abilities_info['ability4'])

        if self.ability_image6_flag:
          PutPortraitAbility(parent_image, self.ability_image6, 6, self.abilities_info['ability5'])
